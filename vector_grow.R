...
graph <- ggplot(legend = TRUE) + 
  ...
  scale_colour_manual("",
                      breaks = c("LuaJIT table.insert()", "Java Vector<Integer>", "Java ArrayList<Integer>", "Rust vector",
                                 "Java Trove TIntArrayList", "LuaJIT index assign", "C++ std::vector", "C libdynamic vector"),
